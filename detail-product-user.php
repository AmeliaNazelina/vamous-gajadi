...
$id_akun = $_SESSION['user_id']; // Mengambil id_akun dari session

// Query untuk mengambil data produk (contoh data gambar)
$query = "SELECT id_produk, foto_produk1, foto_produk2 FROM produk LIMIT 1"; // Mengambil satu baris data produk
...
// Query untuk mengambil data produk tertentu (detail produk)
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Menyimpan produk ke dalam database checkout (tabel checkout)
    $query_insert = "INSERT INTO checkout (id_akun, nama_produk, size, quantity, harga) 
                     VALUES ('$id_akun', '$nama_produk', '$size', '$quantity', '$harga')";
    ...
    if ($result_insert) {
        ...
        echo "Gagal menambahkan produk ke keranjang: " . mysqli_error($koneksi);
    }
}
?>
